...
export  const Success = () => {
    ...
    const fetchData = () => {
	    fetch("http://localhost:8083/email/triggeremail")
	      .then(response => {
	...
	useEffect(() => {
      ...
      return (
             ...
             Tickets Booked
	                   ...
	                   <StyledLabel>Booking id : <b>#{randomNumber}</b></StyledLabel>
	                   <StyledLabel>Seat Number : <b>{"B1,B2"}</b></StyledLabel>
	                   <StyledLabel>Payment Method : <b>Card</b></StyledLabel>
	                   <StyledLabel>Show time : <b>Thu,Jun 11 2022 </b></StyledLabel>
	               </StyledDocTile>
